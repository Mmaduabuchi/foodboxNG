...
<head>
    ...
    <title>Verify Email Address - FoodBox NG</title>
    <style>
        ...
        <tr>
            <td align="center">
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <p style="margin: 0; color: #E6F4F1; font-size: 15px; line-height: 22px; font-weight: 400; max-width: 440px;">
                                            Welcome to FoodBox NG! Please verify your email to get started.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td class="content-card" style="padding: 36px 36px 28px 36px;">
                            ...
                            <p style="margin: 0 0 24px 0; font-size: 15px; color: #4B5563; line-height: 24px;">
                                Thank you for registering with FoodBox NG! To activate your account and enjoy seamless access to fresh produce and food packages, please verify your email address by clicking the button below:
                            </p>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 30px;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $verifyUrl }}" target="_blank" class="cta-button" style="display: inline-block; background-color: #2A9D8F; color: #ffffff; font-size: 16px; font-weight: 700; text-decoration: none; padding: 16px 36px; border-radius: 50px; box-shadow: 0 6px 18px rgba(42, 157, 143, 0.3); transition: all 0.3s ease; text-align: center;">
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        ...
                                        <p style="margin: 0; font-size: 13px; color: #6B7280; line-height: 18px;">
                                            If you didn't create a FoodBox NG account, no further action is required and you can safely ignore this email.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div style="background-color: #F8FAF9; border-radius: 12px; padding: 16px; border: 1px solid #EAEFF2; margin-bottom: 24px;">
                                ...
                                <p style="margin: 0; font-size: 12px; color: #2A9D8F; word-break: break-all; font-family: monospace;">
                                    <a href="{{ $verifyUrl }}" style="color: #2A9D8F; text-decoration: underline;">{{ $verifyUrl }}</a>
                                </p>
                            </div>
                ...
                <p style="margin-top: 20px; font-size: 11px; color: #94A3B8; text-align: center;">
                    This is an automated verification email. Please do not reply directly to this address.
                </p>
