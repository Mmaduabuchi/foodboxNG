...
<body class="bg-brand-grey text-brand-blue antialiased min-h-screen">
    ...
    <aside id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-brand-blue p-6 shadow-xl-heavy lg:translate-x-0">
        ...
        <!-- Navigation Links (Delivery Address is Active) -->
        <nav class="space-y-2">
            <!-- Dashboard -->
            ...
            <a href="foodbox_delivery_address.html" class="nav-link active flex items-center gap-4 text-white font-medium p-3 rounded-xl">
                <i class="fas fa-map-marker-alt text-lg w-6 text-center text-brand-gold"></i>
            ...
            <a href="foodbox_app_settings.html" class="nav-link flex items-center gap-4 text-white/80 font-medium p-3 rounded-xl hover:bg-brand-teal transition-all hover:text-white">
    ...
    <header class="fixed top-0 right-0 w-full lg:w-[calc(100%-16rem)] h-20 bg-white border-b border-gray-100 shadow-sm z-30 flex items-center px-4 md:px-8">
        <div class="flex-grow">
            ...
            <h1 class="text-xl font-bold lg:hidden">Edit Home Address</h1>
        </div>
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="relative group cursor-pointer">
                ...
                <div class="absolute right-0 mt-3 w-48 bg-white border border-gray-100 rounded-xl shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform scale-95 group-hover:scale-100 origin-top-right">
                    ...
                    <a href="foodbox_app_settings.html" class="block px-4 py-2 text-sm text-gray-700 hover:bg-brand-grey"><i class="fas fa-cog mr-2"></i> App Settings</a>
