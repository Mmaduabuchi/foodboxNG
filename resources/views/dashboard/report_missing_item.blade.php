...
<body class="bg-brand-grey text-brand-blue antialiased min-h-screen">
    ...
    <aside id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-brand-blue p-6 shadow-xl-heavy lg:translate-x-0">
        ...
        <!-- Navigation Links (My Packages still active) -->
        <nav class="space-y-2">
            <!-- Dashboard -->
            ...
            <!-- My Packages (Active) -->
            <a href="foodbox_my_packages.html" class="nav-link active flex items-center gap-4 text-white font-medium p-3 rounded-xl hover:bg-brand-teal transition-all">
    ...
    <header class="fixed top-0 right-0 w-full lg:w-[calc(100%-16rem)] h-20 bg-white border-b border-gray-100 shadow-sm z-30 flex items-center px-4 md:px-8">
        <div class="flex-grow">
            ...
            <h1 class="text-xl font-bold lg:hidden">Report an Issue</h1>
        </div>
