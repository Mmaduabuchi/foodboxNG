...
<body class="bg-brand-grey font-sans text-brand-blue antialiased selection:bg-brand-gold selection:text-brand-blue">
    ...
    <section id="home" class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <!-- Decorative blobs -->
        <div class="absolute top-20 right-0 w-96 h-96 bg-brand-orange/20 rounded-full blur-3xl -z-10"></div>
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                ...
                <div class="lg:w-1/2 text-center lg:text-left">
                    <div class="inline-block px-4 py-1.5 rounded-full bg-brand-orange/10 text-brand-orange font-semibold text-sm mb-6 border border-brand-orange/20">
                        🏠 Built for Single Men &amp; Young Professionals
                    </div>
                    <h1 class="text-4xl lg:text-6xl font-bold leading-tight mb-6 text-brand-blue">
                        No Kitchen Stress, <br>
                    ...
                    <p class="text-lg text-gray-600 mb-8 leading-relaxed max-w-lg mx-auto lg:mx-0">
                        Living alone shouldn't mean surviving on takeout. Get bachelor-sized food packs — rice, beans, noodles, oils &amp; provisions — stocked up and delivered right to your apartment door.
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <a href="#packages" class="bg-brand-teal text-white px-8 py-4 rounded-full font-bold text-lg shadow-xl shadow-brand-teal/30 hover:bg-brand-blue hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2">
                            Shop Bachelor Packs <i class="fas fa-utensils text-sm"></i>
                        </a>
                    ...
                    <div class="mt-10 flex flex-wrap items-center justify-center lg:justify-start gap-5 text-gray-500 text-sm font-medium">
                        <div class="flex items-center gap-2">
                            <i class="fas fa-check-circle text-brand-gold"></i> Quick-Prep Items
                        </div>
                        <div class="flex items-center gap-2">
                            <i class="fas fa-check-circle text-brand-gold"></i> Fridge-Ready Packs
                        </div>
                        <div class="flex items-center gap-2">
                            <i class="fas fa-check-circle text-brand-gold"></i> No-Waste Quantities
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:w-1/2 relative">
                    <div class="relative z-10 rounded-3xl overflow-hidden shadow-2xl border-8 border-white transform -rotate-2 hover:rotate-0 transition-transform duration-500">
                        <img src="{{ asset('assets/images/food_home.avif') }}" alt="Bachelor Food Pack Delivery" class="w-full h-[500px] object-cover">
                        ...
                        <div class="absolute bottom-6 left-6 bg-white/95 backdrop-blur p-4 rounded-xl shadow-lg flex items-center gap-4 max-w-xs">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Bachelor Pack dropped at Unity Estate, Lekki</p>
                            </div>
                        </div>
                    </div>

                    <!-- Floating stat badge -->
                    <div class="absolute -top-4 -left-4 z-20 bg-brand-gold text-brand-blue text-xs font-bold px-4 py-2 rounded-full shadow-lg">
                        🍳 500+ Bachelors Fed Weekly
                    </div>

                    <!-- Background graphic elements -->
                    <div class="absolute -top-10 -right-10 w-32 h-32 bg-brand-orange rounded-full opacity-20 blur-2xl"></div>
    ...
    <section id="packages" class="py-20 bg-white relative">
        <div class="container mx-auto px-6">
            <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
                <div class="max-w-2xl">
                    <span class="text-brand-teal font-bold tracking-wider text-sm uppercase">Our Bachelor Bestsellers</span>
