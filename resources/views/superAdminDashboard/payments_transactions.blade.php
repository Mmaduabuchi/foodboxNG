...
<body class="bg-brand-grey text-brand-blue font-sans min-h-screen">
    ...
    <aside id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-brand-blue p-6 shadow-admin lg:translate-x-0">
        ...
        <!-- Navigation Links (Highlight Payments & Transactions) -->
        <nav class="space-y-1.5">
            ...
            <a href="superAdmin_users_management.html" class="nav-link flex items-center gap-4 text-white/70 font-medium p-3 rounded-xl transition-all hover:bg-brand-blue/70 hover:text-white">
                <i class="fas fa-users text-lg w-6 text-center"></i>
                <span>Users Management</span>
            </a>
            <!-- Payments & Transactions (Active) -->
            <a href="#" class="nav-link payments-active flex items-center gap-4 text-white/90 font-semibold p-3 rounded-xl transition-all hover:bg-brand-blue/70">
    ...
    <header class="fixed top-0 right-0 w-full lg:w-[calc(100%-16rem)] h-20 bg-white border-b border-gray-100 shadow-soft z-30 flex items-center px-4 md:px-8 justify-between">
        <h1 class="text-xl font-bold text-brand-blue">Payments & Transactions</h1>
        ...
        <div class="flex items-center space-x-4">
            ...
            <!-- Quick Action Button -->
            <button onclick="promptForManualTransaction()" class="px-4 py-2 bg-brand-gold text-brand-blue font-semibold rounded-xl hover:bg-brand-gold/90 transition-colors shadow-sm-brand flex items-center gap-2">
                <i class="fas fa-exchange-alt"></i>
                <span class="hidden md:inline">Manual Adjustment</span>
            </button>
